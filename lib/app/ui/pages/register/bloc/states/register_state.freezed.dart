...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(email: $email, name: $name, lastname: $lastname, password: $password, vPassword: $vPassword, termsOk: $termsOk)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, name, lastname, password, vPassword, termsOk);
