...
import 'package:le_libros/pages/one.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        title: "le libros",
        routes: {One.ROUTE: (BuildContext context) => One()},
        home: Scaffold(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            Image.asset(
                              'assets/images/fernando-aramburu.jpg',
                              width: 60,
                            ),
                            Image.asset(
                              'assets/images/Patrick-rothfuss.jpg',
                              width: 60,
                            ),
                            Image.asset(
                              'assets/images/Umberto_Eco.jpg',
                              width: 60,
                            )
                          ],
                        ),
